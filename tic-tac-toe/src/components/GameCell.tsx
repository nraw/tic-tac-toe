...
const GameCell: React.FC<GameCellProps> = ({
	...
	const getCellBackgroundColor = () => {
		if (isWinningCell) {
			return winner === 1 ? "bg-blue-200" : "bg-red-200"; // Overall game winning cell matches winner
		}
			...
			<div className="flex w-full h-full relative">
				...
				<div className="w-1/2 h-full flex items-center justify-center">
					{cell[1] !== undefined && !isHidden1 && (
						<div className={`${isWinningCell && winner === 1 ? "ring-2 ring-blue-500 rounded-lg" : ""} ${
				...
				<div className="w-1/2 h-full flex items-center justify-center">
					{cell[2] !== undefined && !isHidden2 && (
						<div className={`${isWinningCell && winner === 2 ? "ring-2 ring-red-500 rounded-lg" : ""} ${
